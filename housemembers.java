...
public class housemembers extends JFrame {
    housemembers(){
        ...
        JLabel Js = new JLabel("Hiiiiiiiiiiiiiiiiiiiiiiiiii ");
        Js.setFont(new Font(Font.SERIF, Font.BOLD ,20));
        Js.setBounds(500,150,200,30);
        Js.setVisible(true);
        add(Js);
        setLayout(null);
        ...
        Jn.setFont(new Font(Font.SERIF, Font.BOLD ,20));
        Jn.setBounds(500,150,200,30);
        Jn.setVisible(true);
        add(Jn);
        setLayout(null);
        
        JTextField textFieldn = new JTextField(30);
        textFieldn.setBounds(700,150,200,30);
	   ...
	   /* JLabel J0 = new JLabel("House.No ");
            ...
            public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "insert into PERSON_DETAILS (P_ID,NAME,GENDER, DATE_OF_BIRTH,\r\n"
							...
							+ "							STATE, COUNTRY, PINCODE) values"+ "('"+textField1.getText()+textFieldn.getText()+"','"+cb1.getSelectedItem()+"','"+textField3.getText()+"','"+cb6.getSelectedItem()+"','"+cb2.getSelectedItem()+"','"+cb.getSelectedItem()+"', '"+textField9.getText()+"','"+textField8.getText()+"','"+textField7.getText()+"','"+textField0.getText()+"','"+textField10.getText()+"')";
					st.execute(sql);
					String sql1 = "insert into login (username,password) values('"+textFieldn.getText()+"','"+textField3.getText()+"')";
					st.execute(sql1);
        ...
        /*Icon icon = new ImageIcon("C:\\Users\\SREE VIRAJITHA\\Downloads\\Census-Duty-Management-main\\Grp-17 CensusDuty Management System\\back arrow.jpeg");*/
